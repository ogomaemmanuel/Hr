  ...
  <div>
    <template v-if="estimateLoaded">
      ...
      <div class="mt-3 pb-5 flex justify-center">
        <div class="mr-2">
          <button @click="updateEstimate" class="button is-primary is-rounded">Save and Send</button>
        </div>
        <div class="ml-2">
...
export default {
  ...
  methods: {
    ...
    updateEstimate() {
      ...
      axios.put(`/api/estimates/${this.estimateId}`,
